...
export default class PortfolioManager extends Component {
    ...
    getPortfolioItems() {
        axios
            .get("https://sombatmayer.devcamp.space/portfolio/portfolio_items?order_by=created_at&direction=desc", { withCredentials: true })
            .then(response => {
            ...
            <div className="portfolio-manager-wrapper">
                <div className="left-column">
                    <PortfolioForm
                        ...
                        handleEdiFormSubmission={this.handleEditFormSubmission}
